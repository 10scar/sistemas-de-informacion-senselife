@php
    $mostrarCentroEnModal = $mostrarCentroEnModal ?? true;
...
@if ($showAddMedicoModal)
    <div
        ...
        <div
            ...
            <form wire:submit.prevent="guardarMedico" class="flex min-h-0 min-w-0 flex-1 flex-col gap-5">

                @if ($mostrarCentroEnModal)
                    {{-- Centro fijo (solo admin) --}}
