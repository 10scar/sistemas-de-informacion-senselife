@if ($showDesactivarPersonalModal)
    <div
        wire:key="desactivar-personal-modal"
        class="fixed inset-0 z-[60] flex items-center justify-center bg-text/40 p-4"
        wire:click.self="closeDesactivarPersonalModal"
        role="dialog"
        aria-modal="true"
        aria-labelledby="desactivar-personal-title">
        <div
            wire:click.stop
            ...
            <div
                ...
                aria-label="{{ __('admin/centros-medicos.show.desactivar_personal_modal.icon_aria') }}">
            ...
            <div class="mb-8 flex flex-col gap-2">
                <h2 id="desactivar-personal-title" class="text-xl font-bold leading-tight text-text md:text-[22px]">
                    {{ __('admin/centros-medicos.show.desactivar_personal_modal.title') }}
                </h2>
                <p class="px-2 text-sm leading-relaxed text-neutral-600">
                    {{ __('admin/centros-medicos.show.desactivar_personal_modal.description', ['nombre' => $deactivatingPersonalNombre]) }}
                </p>
            </div>
            ...
            <div class="flex w-full items-center gap-3">
                <button
                    type="button"
                    wire:click="closeDesactivarPersonalModal"
                    ...
                    {{ __('admin/centros-medicos.show.desactivar_personal_modal.cancel') }}
                </button>
                <button
                    type="button"
                    wire:click="confirmDesactivarPersonal"
                    ...
                    {{ __('admin/centros-medicos.show.desactivar_personal_modal.confirm') }}
                </button>
            </div>
        </div>
    </div>
