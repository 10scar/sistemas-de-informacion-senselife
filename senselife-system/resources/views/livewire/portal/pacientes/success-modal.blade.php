@if ($showSuccessModal)
    <div
        wire:key="portal-paciente-success-modal"
        x-data
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="portal-paciente-success-title">
        <div
            wire:click.stop
            ...
            <div class="flex size-14 shrink-0 items-center justify-center rounded-full bg-success-mid"
                aria-label="{{ __('portal/pacientes.success_modal.icon_aria') }}">
            ...
            <h2 id="portal-paciente-success-title"
                class="px-4 text-xl font-bold leading-tight text-text md:text-[22px]">
                {{ $successTitle !== '' ? $successTitle : __('portal/pacientes.success_modal.title') }}
            </h2>
            ...
            <div class="mt-2 flex w-full justify-center">
                <button
                    ...
                    {{ __('portal/pacientes.success_modal.continue') }}
                </button>
            </div>
        </div>
    </div>
